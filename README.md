...
To install a Python virtual environment capable of rerunning the analyses, run the [`setup.sh`](`setup.sh`) shell script.
...
The codebase was tested with Python version 3.12.3.
